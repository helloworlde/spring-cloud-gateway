		...
		return builder.routes()
		              ...
		              .route("rewrite_request_upper",
				              r -> r.host("*.rewriterequestupper.org")
				                    .filters(f -> f
				                                   .addResponseHeader("X-TestHeader",
						                                   "rewrite_request_upper")
		              ...
		              .route("rewrite_empty_response",
				              r -> r.host("*.rewriteemptyresponse.org")
				                    .filters(f -> f
				                                   .addResponseHeader("X-TestHeader",
						                                   "rewrite_empty_response")
				                                   .modifyResponseBody(String.class, String.class,
						                                   (exchange, s) -> {
							                                   if (s == null) {
		              ...
		              .route("rewrite_response_fail_supplier",
				              r -> r.host("*.rewriteresponsewithfailsupplier.org")
				                    .filters(f -> f
		              ...
		              .route(r -> r.order(-1).host("**.throttle.org").and().path("/get")
		                           .filters(f -> f
		                                          .filter(new ThrottleGatewayFilter().setCapacity(1)
		                                                                             .setRefillTokens(1)
		                                                                             .setRefillPeriod(10)
